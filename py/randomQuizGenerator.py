...
# create related answers in another file
for quizNum in range(35):
    ...
    # Write out the header for the quiz.
        # write some line in every quizFile
        # Name:
        # 
        #
        # Date:
    ...
    for questionNum in range(50):
        ...
        del wrongAnswers[wrongAnswers.index(correctAnswer)]
            # Assignment random 3 elements from the wrong answers list
        wrongAnswers = random.sample(wrongAnswers, 3)
            # Assignment 4 options to the answerOptions 
